...
public class employee_wage
{
	...
	public static void main(String args[])
	{
		...
		employee_wage company1 = new employee_wage("DMart", 20, 9, 110, 26);
		company.put("DMart",company1.MonthlyWage());
		employeew_age company2 = new employee_wage("Reliance", 24, 8, 135, 20);
		company.put("Reliance",company2.MonthlyWage());
		employeew_age company3 = new employee_wage("Big Bazaar", 20, 9, 120, 26);
